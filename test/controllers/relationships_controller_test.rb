...
class RelationshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relationship" do
    assert_difference("Relationship.count") do
      post relationships_url, params: { relationship: { followed_id: @relationship.followed_id, follower_id: @relationship.follower_id } }
    end
  ...
  test "should update relationship" do
    patch relationship_url(@relationship), params: { relationship: { followed_id: @relationship.followed_id, follower_id: @relationship.follower_id } }
